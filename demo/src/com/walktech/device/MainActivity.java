...
//					mHandler.obtainMessage(MESSAGE_SWIPER, 0, 0,
//							" CardType: unknown.").sendToTarget();
//					mHandler.obtainMessage(MESSAGE_SWIPER, 0, 0,
//							" UID: " + uuid).sendToTarget();
//				}
//				try {
//					Thread.sleep(100);
...
//						e.printStackTrace();
//					}
//					byte[] APDU3 = new byte[]{(byte)0x80,(byte)0xCA,(byte)0x9F,(byte)0x79,(byte)0x00};
//					sl = mmposService.PCDSendRecv(APDU3, APDU3.length, resp);
//					if((resp[0] != 0x00) && (sl > 0)) {
//						mHandler.obtainMessage(MESSAGE_SWIPER, 0, 0,
//								"读取E-Cash失败." + resp[0]).sendToTarget();
//						return;
//					}
//					str = "";
//					for(int i = 1; i < sl; i++) {
...
//					}
//					if(str.length() > 3) {
//						Map<String, TLV> tags = TLVUtils.builderTlvMap(str);
//						TLV tag9F79 = tags.get("9F79");
//						if(tag9F79 != null) {
//							String val = tag9F79.getValue();
//							if ((val != null) && (val.length() > 0)) {
//								double bal = Double.parseDouble(val);
//								mHandler.obtainMessage(MESSAGE_SWIPER, 0, 0,
//										" E-Cash: " + bal / 100.0).sendToTarget();
//							}
//						}
//					}
//				} catch (Exception e) {
